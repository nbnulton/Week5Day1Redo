from flask import render_template, request, redirect, url_for, flash     # importing flask package from Flask class
...
def register():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        return redirect(url_for('auth.login')) #2 on a POST request that successfully creates a new user
